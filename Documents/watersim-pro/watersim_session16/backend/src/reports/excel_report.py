"""
SafeKrit — Excel Report Generator
...
def build_single(wb, data):
    ...
    c = ws["A1"]
    c.value = "SafeKrit — Simulation Report"
...
def build_comparison(wb, runs):
    ...
    ws["A1"].value = "SafeKrit — Scenario Comparison Report"
    ...
    wl.cell(footer_r, 1).value = f"Generated by SafeKrit on {datetime.utcnow().strftime('%Y-%m-%d %H:%M')} UTC"
